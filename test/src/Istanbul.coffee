...
describe 'Istanbul', ->
  it 'should merge collected Istanbul coverage data with the coverage data on the global object', ->
    globalData =
      __coverage__:
        file1:
          otherProperty: 'hello'
  ...
  it 'should add collected Istanbul coverage data if there is no coverage data on the global object', ->
    globalData = {}
    istanbul = new Istanbul globalData
